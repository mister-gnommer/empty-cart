---
name: commit
description: git commit, commit message, committing changes — commit message format conventions. Use when the user asks to commit, write a commit message, or otherwise interact with git commits.
---
